...
2. Windows Remote Management (HTTP-In) needs to be enables. use New-
NetFirewallRule to set the firewall rules.
...
function Network-Tests {
    ...
    Begin {
        ...
        #TODO: I need to send the list of $computerNames to the next part of the process (Foreach).
